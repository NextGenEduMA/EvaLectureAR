...
---"""
        ...
        # Create the prompt
        prompt = f"""أنت مساعد ذكي متخصص في الإجابة على الأسئلة باللغة العربية باستخدام المعلومات المقدمة.
...
تعليمات:
1. أجب على السؤال باستخدام المعلومات المقدمة في السياق فقط
2. إذا لم تجد إجابة كافية في السياق، قل "لا توجد معلومات كافية في المصادر المتاحة"
3. استشهد بالمصادر عند الإجابة (مثل: "حسب المصدر 1...")
